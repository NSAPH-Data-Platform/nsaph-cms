...
:class:`Abstract class for CMS FTS file <cms.tools.fts2yaml.CMSFTS>`_
:class:`Concrete subclass describing Medicare FTS file <cms.tools.fts2yaml.MedicareFTS>`_
:class:`Concrete subclass describing Medicaid FTS file <cms.tools.fts2yaml.MedicaidFTS>`_

:class:`Abstract class describing a column in a CMS data file <cms.tools.fts2yaml.FTSColumn>`_
:class:`Concrete subclass describing a column in a Medicaid data file<cms.tools.fts2yaml.MedicaidFTSColumn>`_
:class:`Concrete subclass describing a column in a Medicaid data file<cms.tools.fts2yaml.MedicareFTSColumn>`_
:class:`Concrete subclass describing a column not present in the original data but that should be generated in the database <cms.tools.fts2yaml.AliasColumn>`_
